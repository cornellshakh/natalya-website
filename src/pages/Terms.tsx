  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <Section spacing="sm" containerSize="content">
        ...
        >
          <h1 className="text-4xl font-serif font-bold text-brand-navy mb-4">{t('terms.title')}</h1>
          <p className="text-lg text-neutral-600 max-w-2xl mx-auto">{t('terms.subtitle')}</p>
        </motion.div>
      </Section>
        ...
        <motion.div {...fadeInUp} className="prose prose-lg max-w-none">
          <div className="space-y-4">
            <section>
              ...
              <p className="text-neutral-700 leading-relaxed">{t('terms.introduction.content')}</p>
            </section>
            ...
            <section>
              ...
              <p className="text-neutral-700 leading-relaxed mb-4">{t('terms.services.content')}</p>
            ...
            <section>
              ...
              <ul className="space-y-2 ml-6">
                <li className="text-neutral-700 list-disc">
                  {t('terms.responsibilities.items.0')}
                </li>
                <li className="text-neutral-700 list-disc">
                  {t('terms.responsibilities.items.1')}
                </li>
                <li className="text-neutral-700 list-disc">
                  {t('terms.responsibilities.items.2')}
                </li>
                <li className="text-neutral-700 list-disc">
                  {t('terms.responsibilities.items.3')}
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="text-neutral-700 leading-relaxed">{t('terms.payment.content')}</p>
            </section>
            ...
            <section>
              ...
              <p className="text-neutral-700 leading-relaxed">{t('terms.liability.content')}</p>
            </section>
            ...
            <section>
              ...
              <p className="text-neutral-700 leading-relaxed">{t('terms.termination.content')}</p>
            </section>
            ...
            <section>
              ...
              <p className="text-neutral-700 leading-relaxed">{t('terms.changes.content')}</p>
            </section>
            ...
            <section>
              ...
              <p className="text-neutral-700 leading-relaxed mb-4">{t('terms.contact.content')}</p>
