...
export default function Services() {
  ...
  const mainServices = [
    {
      title: language === 'cs' ? 'Komplexní vedení účetnictví a ekonomické služby' : 'Комплексное ведение бухгалтерии и экономические услуги',
      ...
      features: [
        language === 'cs' ? 'Vedení účetnictví (dříve podvojné účetnictví)' : 'Ведение бухгалтерии (ранее двойная бухгалтерия)',
        language === 'cs' ? 'Daňová evidence (dříve jednoduché účetnictví)' : 'Налоговый учет (ранее простая бухгалтерия)',
        language === 'cs' ? 'Personální a mzdová agenda' : 'Кадровая работа и расчет заработной платы',
        ...
        language === 'cs' ? 'Předávání dokladů dle dohody s klienty' : 'Передача документов по договоренности с клиентами'
      ]
    },
    {
      ...
      features: [
        language === 'cs' ? 'Příprava daňových přiznání (daň z příjmů FO a PO, DPH, silniční daň, atd.)' : 'Подготовка налоговых деклараций (подоходный налог ФЛ и ЮЛ, НДС, дорожный налог и т.д.)',
        language === 'cs' ? 'Daňové poradenství a optimalizace' : 'Налоговое консультирование и оптимизация',
        language === 'cs' ? 'Mezinárodní zdanění' : 'Международное налогообложение',
        language === 'cs' ? 'Komunikace a zastupování před finančním úřadem' : 'Общение и представительство перед налоговой инспекцией',
        language === 'cs' ? 'Nastavení a tvorba dokumentace k převodním cenám' : 'Настройка и создание документации по трансфертному ценообразованию',
        language === 'cs' ? 'Daňové a finanční due-diligence' : 'Налоговый и финансовый due-diligence'
      ]
    },
    {
      ...
      features: [
        language === 'cs' ? 'Obchodní právo a zakládání společností' : 'Коммерческое право и регистрация компаний',
  ...
  const pricingExamples = [
    {
      ...
      items: [
        {
          service: language === 'cs' ? 'Právnická osoba neplátce DPH' : 'Юридическое лицо неплательщик НДС',
          price: language === 'cs' ? 'od 2.000 Kč' : 'от 2.000 крон'
        },
        {
          service: language === 'cs' ? 'Právnická osoba plátce DPH' : 'Юридическое лицо плательщик НДС',
          price: language === 'cs' ? 'od 3.000 Kč' : 'от 3.000 крон'
        },
        {
          service: language === 'cs' ? 'Fyzická osoba neplátce DPH' : 'Физическое лицо неплательщик НДС',
          price: language === 'cs' ? 'od 1.000 Kč' : 'от 1.000 крон'
        },
        {
          service: language === 'cs' ? 'Fyzická osoba plátce DPH' : 'Физическое лицо плательщик НДС',
          price: language === 'cs' ? 'od 1.500 Kč' : 'от 1.500 крон'
        },
        {
          service: language === 'cs' ? 'Zpracování účetní závěrky' : 'Обработка финансовой отчетности',
    ...
    },
    {
      ...
      items: [
        {
          service: language === 'cs' ? 'Měsíční mzda do 5 zaměstnanců' : 'Месячная зарплата до 5 сотрудников',
          price: language === 'cs' ? '300 Kč/zam' : '300 крон/сотр'
        },
        {
          service: language === 'cs' ? 'Měsíční mzda nad 10 zaměstnanců' : 'Месячная зарплата свыше 10 сотрудников',
    ...
    },
    {
      ...
      items: [
        {
          service: language === 'cs' ? 'Daň z příjmů právnických osob včetně příloh' : 'Подоходный налог юридических лиц включая приложения',
          price: language === 'cs' ? 'od 4.000 Kč' : 'от 4.000 крон'
        },
        {
          service: language === 'cs' ? 'Daň z příjmů fyzických osob' : 'Подоходный налог физических лиц',
          price: language === 'cs' ? 'od 1.500 Kč' : 'от 1.500 крон'
        },
        {
          service: language === 'cs' ? 'Daň z příjmů FO OSVČ včetně přehledů SP a ZP' : 'Подоходный налог ФЛ ИП включая отчеты соцстрах',
          price: language === 'cs' ? 'od 2.500 Kč' : 'от 2.500 крон'
        },
        {
          service: language === 'cs' ? 'DPH včetně souhrnného hlášení' : 'НДС включая сводную декларацию',
          price: language === 'cs' ? 'od 500 Kč' : 'от 500 крон'
        },
        {
    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="text-center">
            <div className="inline-flex items-center gap-3 border border-brand-emerald/20 rounded-full px-6 py-3">
              ...
              <span className="text-neutral-700 font-medium">
                {language === 'cs' ? 'Certifikovaný účetní s licencí ČR' : 'Сертифицированный бухгалтер с лицензией ЧР'}
              </span>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl font-bold text-neutral-900 mb-4">
              {language === 'cs' ? 'Ilustrační ceník našich služeb' : 'Иллюстративный прайс-лист наших услуг'}
            </h2>
            ...
            <motion.div {...fadeInUp}>
              ...
              <div className="space-y-6">
                {[
                  ...
                  {
                    title: language === 'cs' ? 'Transparentní komunikace' : 'Прозрачная коммуникация',
                    description: language === 'cs'
