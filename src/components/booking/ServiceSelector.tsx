...
export default function ServiceSelector({
  ...
  const services: ServiceOption[] = [
    ...
    },
    {
      ...
      description: language === 'cs' ? 'Pro malé podnikatele a OSVČ' : 'Для малого бизнеса и ИП',
      price: '4.999',
    ...
    },
    {
      ...
      description: language === 'cs' ? 'Kompletní mzdová agenda' : 'Полное управление зарплатой',
      price: '299',
    ...
    },
    {
      ...
      description:
        language === 'cs' ? 'Optimalizace daňové zátěže' : 'Оптимизация налоговой нагрузки',
      price: '2.499',
      period: language === 'cs' ? 'měsíčně' : 'в месяц',
      icon: Receipt,
      features:
          ...
          {selectedService && (
            ...
            >
              <h4 className="font-medium text-brand-emerald mb-2">
                {language === 'cs' ? 'Vybraná služba:' : 'Выбранная услуга:'}{' '}
